...
let g:python3_host_prog='/opt/homebrew/bin/python3'            " ncm2-jedi
...
" Theme settings
colorscheme darkblue                  " use vim-one colorscheme
...
map <Leader>tp :new term://bash<CR>ibpython<CR><C-\><C-n><C-w>k
